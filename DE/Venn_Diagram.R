...
significant_genes_AtK3_AtF3 <- subset(res_AtK3_AtF3, padj <= 0.05 & abs(log2FoldChange) >= 2)
...
significant_genes_AtK5_AtF5 <- subset(res_AtK5_AtF5, padj <= 0.05 & abs(log2FoldChange) >= 2)
...
significant_genes_AtF3_AtF5 <- subset(res_AtF3_AtF5, padj <= 0.05 & abs(log2FoldChange) >= 2)
...
### для up генов
## AtF3 vs AtK3
up_significant_genes_AtK3_AtF3 <- subset(res_AtK3_AtF3, padj <= 0.05 & log2FoldChange >= 2)
...
## AtF5 vs AtK5
up_significant_genes_AtK5_AtF5 <- subset(res_AtK5_AtF5, padj <= 0.05 & log2FoldChange >= 2)
...
## AtF3 vs AtF5
up_significant_genes_AtF3_AtF5 <- subset(res_AtF3_AtF5, padj <= 0.05 & log2FoldChange >= 2)
...
### для down генов
## AtF3 vs AtK3
down_significant_genes_AtK3_AtF3 <- subset(res_AtK3_AtF3, padj <= 0.05 & log2FoldChange <= - 2)
